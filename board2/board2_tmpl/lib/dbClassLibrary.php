...
#---
$listData = $dbLibraryObject->fnDBGetList("SELECT * FROM {{cms.tableNamePrefix}}");
#---
...
if($dbLibraryObject!=null){
	$listData = $dbLibraryObject->fnDBGetList("SELECT * FROM {{cms.tableNamePrefix}}_info");
...
class DBLibraryClass {
	...
	# $listArray = fnDBGetList("SELECT * FROM {{cms.tableNamePrefix}}");
	...
	# $rowData = fnDBGetRow("SELECT * FROM {{cms.tableNamePrefix}}");
	...
	# $listTotalCount = fnDBGetIntValue("SELECT count(*) FROM {{cms.tableNamePrefix}}");
	...
	# $listTotalCount = fnDBGetValue("SELECT count(*) FROM {{cms.tableNamePrefix}}");
	...
	# $titleString = fnDBGetStringValue("SELECT title FROM {{cms.tableNamePrefix}}");
	...
	# $affectedRows = fnDBUpdate("UPDATE {{cms.tableNamePrefix}}_article SET bda_title = 'aaaa' WHERE bda_seq = 0");
