...
include($_SERVER["DOCUMENT_ROOT"].'/{{cms.prefix}}/brdMas/boardLibraryInclude.php');
#---
$boardInfo = null;
...
if($actionString=="write"){
	...
	#---
	$sql = "
		insert into {{cms.tableNamePrefix}}_article (
			bda_title
			,bda_content
			,bd_seq
			,bda_fix_yn
	...
	#---
	$sql = "
		delete from {{cms.tableNamePrefix}}_article
		where bda_seq = ${bdaSeq}
	";
	#---
	fnDBUpdate($sql);
