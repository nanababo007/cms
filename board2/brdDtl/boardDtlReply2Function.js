...
Reply2Class.prototype.setReply2Objects = function(){
	...
	if(thisObject.bdrFixYn==='Y'){
		thisObject.reply2ListItemAreaJqueryObject = $('#reply2ListItemArea'+thisObject.bdrSeq+'Fix');
		...
		thisObject.reply2ListItemAreaJqueryObject = $('#reply2ListItemArea'+thisObject.bdrSeq);
